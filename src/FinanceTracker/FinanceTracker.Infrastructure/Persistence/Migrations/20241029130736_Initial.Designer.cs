...
namespace FinanceTracker.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20241029130736_Initial")]
            ...
            modelBuilder.Entity("FinanceTracker.Domain.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 10, 29, 13, 7, 35, 718, DateTimeKind.Unspecified).AddTicks(1537), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedBy = 0,
                            Name = "Groceries",
                            Period = 0,
