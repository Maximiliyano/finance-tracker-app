...
public sealed class GetByIdCategoryQueryHandlerTests
{
    ...
    public async Task Handle_ShouldGetCategoryById_WhenCategoryExists_ReturnCategory()
    {
        ...
        var response = new CategoryResponse(id, category.Name, category.Type, category.Period, category.PlannedPeriodAmount, category.TotalExpenses, category.TotalIncomes, [], []);
